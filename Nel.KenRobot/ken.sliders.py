...
# import the ken robot from the other file
from ken import ken

CYL_RADIUS = 0.01
CYL_COLOR  = "#3478f6"

def run_with_sliders(bot: ken):
    """
    ...
    robot_for_cyl = rtb.DHRobot(bot.links, name="KenCyl")
...
if __name__ == "__main__":
    # Create an instance of the ken robot
    robot = ken()
